...
#Tissue_SNP_Gene_mapping.txt contains the mapping information generated by CoDeS3D using genometic Hi-C information to map the GWAS SNPs to their tissue specific eQTL effects.
